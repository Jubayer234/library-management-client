...
const BookDetailRoute3 = ({card}) => {
    const { id, BookImg3, category, BookName3,authorName3 } = card || {};
    return (
        <div className='max-w-7xl mx-auto'>
            <div className="card w-[350px] md:w-[550px] mx-auto bg-base-100 shadow-xl">
                <figure className="px-10 pt-10">
                    <img src={BookImg3} className="w-[500px] lg:h-[500px] rounded-xl" />
                </figure>
                <div className="card-body items-center text-center text-xl font-semibold">
                    <h2 className="card-title">Category : {category}</h2>
                    <p>Book Name : {BookName3}</p>
                    <p>Author Name : {authorName3}</p>
...
export default BookDetailRoute3